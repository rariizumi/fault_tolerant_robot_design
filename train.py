...
def main():
    ...
    if args.debug:
        print("initial_params_filename = ", cfg["initial_params_filename"])
        print("failuer_occurrence = ", cfg["env_specific_cfg"]["robot_cfg"]["failure_occurrence"])
        print("failuer_type = ", cfg["env_specific_cfg"]["robot_cfg"]["failure_type"])
